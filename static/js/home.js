/*
 * Файл JavaScript для демонстрации приложения
 * используя API
 */

// Создание экземпляров пространства имен
let ns = {};
...
ns.controller = (function(m, v) {
    ...
    // Получение данных из модели после завершения инициализации контроллера
    setTimeout(function() {
        model.read();
    }, 100)
